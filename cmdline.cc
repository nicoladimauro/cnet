/*
  ...
  gengetopt -i command.ggo -G -c cc 
...
const char *gengetopt_args_info_purpose = "CNets implementation in C++.\n\nBy Nicola Di Mauro";

const char *gengetopt_args_info_usage = "Usage: cnet [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --model=STRING       The model to use  (possible values=\"cnet\",\n                             \"xcnet\", \"optioncnet\", \"optionxcnet\"\n                             default=`cnet')",
  "      --option-length=INT  The number of or nodes in the option nodes\n                             (default=`3')",
  "      --ensemble           Whether to build an ensemble model  (default=off)",
  "      --k=INT              The number of ensemble components  (default=`5')",
...
const char *cmdline_parser_model_values[] = {"cnet", "xcnet", "optioncnet", "optionxcnet", 0}; /*< Possible values for model. */
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->problem_given = 0 ;
  args_info->min_inst_given = 0 ;
  args_info->min_feat_given = 0 ;
  args_info->alpha_given = 0 ;
  args_info->output_dir_given = 0 ;
  args_info->model_given = 0 ;
  args_info->option_length_given = 0 ;
  args_info->ensemble_given = 0 ;
  args_info->k_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->problem_arg = NULL;
  args_info->problem_orig = NULL;
  args_info->min_inst_arg = NULL;
  args_info->min_inst_orig = NULL;
  args_info->min_feat_arg = NULL;
  args_info->min_feat_orig = NULL;
  args_info->alpha_arg = NULL;
  args_info->alpha_orig = NULL;
  args_info->output_dir_arg = gengetopt_strdup ("exp");
  args_info->output_dir_orig = NULL;
  args_info->model_arg = gengetopt_strdup ("cnet");
  args_info->model_orig = NULL;
  args_info->option_length_arg = NULL;
  args_info->option_length_orig = NULL;
  args_info->ensemble_flag = 0;
  args_info->k_arg = 5;
  args_info->k_orig = NULL;
  args_info->seed_arg = 117;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->problem_help = gengetopt_args_info_help[2] ;
  args_info->min_inst_help = gengetopt_args_info_help[3] ;
  args_info->min_inst_min = 1;
  args_info->min_inst_max = 0;
  args_info->min_feat_help = gengetopt_args_info_help[4] ;
  args_info->min_feat_min = 1;
  args_info->min_feat_max = 0;
  args_info->alpha_help = gengetopt_args_info_help[5] ;
  args_info->alpha_min = 1;
  args_info->alpha_max = 0;
  args_info->output_dir_help = gengetopt_args_info_help[6] ;
  args_info->model_help = gengetopt_args_info_help[7] ;
  args_info->option_length_help = gengetopt_args_info_help[8] ;
  args_info->option_length_min = 1;
  args_info->option_length_max = 0;
  args_info->ensemble_help = gengetopt_args_info_help[9] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->problem_arg));
  free_string_field (&(args_info->problem_orig));
  free_multiple_field (args_info->min_inst_given, (void *)(args_info->min_inst_arg), &(args_info->min_inst_orig));
  args_info->min_inst_arg = 0;
  free_multiple_field (args_info->min_feat_given, (void *)(args_info->min_feat_arg), &(args_info->min_feat_orig));
  args_info->min_feat_arg = 0;
  free_multiple_field (args_info->alpha_given, (void *)(args_info->alpha_arg), &(args_info->alpha_orig));
  ...
  free_multiple_field (args_info->option_length_given, (void *)(args_info->option_length_arg), &(args_info->option_length_orig));
  args_info->option_length_arg = 0;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->problem_given)
    write_into_file(outfile, "problem", args_info->problem_orig, 0);
  write_multiple_into_file(outfile, args_info->min_inst_given, "min-inst", args_info->min_inst_orig, 0);
  write_multiple_into_file(outfile, args_info->min_feat_given, "min-feat", args_info->min_feat_orig, 0);
  write_multiple_into_file(outfile, args_info->alpha_given, "alpha", args_info->alpha_orig, 0);
  ...
  write_multiple_into_file(outfile, args_info->option_length_given, "option-length", args_info->option_length_orig, 0);
  if (args_info->ensemble_given)
    write_into_file(outfile, "ensemble", 0, 0 );
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->problem_given)
    {
      fprintf (stderr, "%s: '--problem' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->min_inst_given, args_info->min_inst_min, args_info->min_inst_max, "'--min-inst'"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->min_feat_given, args_info->min_feat_min, args_info->min_feat_max, "'--min-feat'"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->alpha_given, args_info->alpha_min, args_info->alpha_max, "'--alpha'"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->option_length_given, args_info->option_length_min, args_info->option_length_max, "'--option-length'"))
     error_occurred = 1;
  
  
  /* checks for dependences among options */
  if (args_info->k_given && ! args_info->ensemble_given)
    {
      fprintf (stderr, "%s: '--k' option depends on option 'ensemble'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * min_inst_list = NULL;
  struct generic_list * min_feat_list = NULL;
  struct generic_list * alpha_list = NULL;
  struct generic_list * option_length_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Input problem name.  */
          if (strcmp (long_options[option_index].name, "problem") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->problem_arg), 
                 &(args_info->problem_orig), &(args_info->problem_given),
                &(local_args_info.problem_given), optarg, 0, 0, ARG_STRING,
          ...
          /* Minimum number of instances for a slice.  */
          else if (strcmp (long_options[option_index].name, "min-inst") == 0)
          {
          
            if (update_multiple_arg_temp(&min_inst_list, 
                &(local_args_info.min_inst_given), optarg, 0, "500", ARG_INT,
                "min-inst", '-',
                additional_error))
              goto failure;
          
          }
          /* Minimum number of features for a slice.  */
          else if (strcmp (long_options[option_index].name, "min-feat") == 0)
          {
          
            if (update_multiple_arg_temp(&min_feat_list, 
                &(local_args_info.min_feat_given), optarg, 0, "4", ARG_INT,
                "min-feat", '-',
                additional_error))
              goto failure;
          
          }
          /* Pseudocounts for the smoothing.  */
          else if (strcmp (long_options[option_index].name, "alpha") == 0)
          {
          
            if (update_multiple_arg_temp(&alpha_list, 
                &(local_args_info.alpha_given), optarg, 0, "1", ARG_DOUBLE,
                "alpha", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "output-dir") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->output_dir_arg), 
                ...
                &(local_args_info.output_dir_given), optarg, 0, "exp", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "output-dir", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "model") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->model_arg), 
                ...
                &(local_args_info.model_given), optarg, cmdline_parser_model_values, "cnet", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "model", '-',
                additional_error))
              goto failure;
          ...
          /* The number of or nodes in the option nodes.  */
          else if (strcmp (long_options[option_index].name, "option-length") == 0)
          {
          
            if (update_multiple_arg_temp(&option_length_list, 
                &(local_args_info.option_length_given), optarg, 0, "3", ARG_INT,
                "option-length", '-',
                additional_error))
              goto failure;
          
          }
          /* Whether to build an ensemble model.  */
          else if (strcmp (long_options[option_index].name, "ensemble") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->ensemble_flag), 0, &(args_info->ensemble_given),
                &(local_args_info.ensemble_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "ensemble", '-',
                additional_error))
              goto failure;
          
          }
          /* The number of ensemble components.  */
          else if (strcmp (long_options[option_index].name, "k") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->k_arg), 
                 &(args_info->k_orig), &(args_info->k_given),
                &(local_args_info.k_given), optarg, 0, "5", ARG_INT,
                check_ambiguity, override, 0, 0,
                "k", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "seed") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->seed_arg), 
                ...
                &(local_args_info.seed_given), optarg, 0, "117", ARG_INT,
                check_ambiguity, override, 0, 0,
                "seed", '-',
                additional_error))
              goto failure;
  ...
  multiple_default_value.int_arg = 500;
  update_multiple_arg((void *)&(args_info->min_inst_arg),
    &(args_info->min_inst_orig), args_info->min_inst_given,
    local_args_info.min_inst_given, &multiple_default_value,
    ARG_INT, min_inst_list);
  multiple_default_value.int_arg = 4;
  update_multiple_arg((void *)&(args_info->min_feat_arg),
    &(args_info->min_feat_orig), args_info->min_feat_given,
    local_args_info.min_feat_given, &multiple_default_value,
    ARG_INT, min_feat_list);
  multiple_default_value.double_arg = 1;
  update_multiple_arg((void *)&(args_info->alpha_arg),
    &(args_info->alpha_orig), args_info->alpha_given,
    local_args_info.alpha_given, &multiple_default_value,
    ARG_DOUBLE, alpha_list);
  multiple_default_value.int_arg = 3;
  update_multiple_arg((void *)&(args_info->option_length_arg),
    &(args_info->option_length_orig), args_info->option_length_given,
    local_args_info.option_length_given, &multiple_default_value,
    ARG_INT, option_length_list);

  args_info->min_inst_given += local_args_info.min_inst_given;
  local_args_info.min_inst_given = 0;
  args_info->min_feat_given += local_args_info.min_feat_given;
  local_args_info.min_feat_given = 0;
  args_info->alpha_given += local_args_info.alpha_given;
  local_args_info.alpha_given = 0;
  args_info->option_length_given += local_args_info.option_length_given;
  local_args_info.option_length_given = 0;
...
failure:
  free_list (min_inst_list, 0 );
  free_list (min_feat_list, 0 );
  free_list (alpha_list, 0 );
  free_list (option_length_list, 0 );
