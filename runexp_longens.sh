...
./learnenscnet --problem=accidents --min-inst=1000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.1 --ensemble --k 1000 > exp/longensxcnet/accidents.log
...
./learnenscnet --problem=bnetflix --min-inst=300 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.5 --ensemble --k 1000 > exp/longensxcnet/bnetflix.log
...
./learnenscnet --problem=kdd --min-inst=1000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.2 --ensemble --k 1000 > exp/longensxcnet/kdd.log
...
./learnenscnet --problem=book --min-inst=2000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.2 --ensemble --k 1000 > exp/longensxcnet/book.log
./learnenscnet --problem=cr52 --min-inst=1000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.2 --ensemble --k 1000 > exp/longensxcnet/cr52.log
...
./learnenscnet --problem=msnbc --min-inst=1000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.2 --ensemble --k 1000 > exp/longensxcnet/msnbc.log
./learnenscnet --problem=nltcs --min-inst=1000 --min-feat=4 --output-dir=exp/longensxcnet --model=xcnet --option-length=5,4,2 --alpha=0.1 --ensemble --k 1000 > exp/longensxcnet/nltcs.log
